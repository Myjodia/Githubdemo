...
class CardView1 extends StatefulWidget {
  ...
  @override
  _CardView1State createState() => _CardView1State();
}

class _CardView1State extends State<CardView1> {
  TextEditingController controller = new TextEditingController();
  List<Githubusers> _searchResult = [];

  _onChanged(String value) {
    setState(() {
      _searchResult = widget.data
        ...
        Expanded(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              Githubusers userdata = widget.data[index];
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Center(
                      child: Text(
                    userdata.nodeId == null ? '' : userdata.nodeId,
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => Profile(url: userdata.url)));
                  },
                ),
              );
            },
